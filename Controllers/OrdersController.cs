...
namespace Mare_Bogdan_Lab2_EB.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Mare_Bogdan_Lab2_EBContext context)
        {
            _context = context;
        }
        ...
        {
            var mare_Bogdan_Lab2_EBContext = _context.Order.Include(o => o.Book).Include(o => o.Customer);
            return View(await mare_Bogdan_Lab2_EBContext.ToListAsync());
        }
